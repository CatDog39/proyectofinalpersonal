                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-12 col-md-4">
                            <img src="https://firebasestorage.googleapis.com/v0/b/spotyabc-41b7d.appspot.com/o/hdsimg1.webp?alt=media&token=8a7f4fad-0e73-474c-9384-d2fa16e1661e" alt="" className="img-fluid w-100"/>
                            <p>
                                La banda se separa temporalmente por problemas personales de faldas
                            </p>
                        </div>
                        <div className="col-12 col-md-4">
                            <img src="https://firebasestorage.googleapis.com/v0/b/spotyabc-41b7d.appspot.com/o/hdsimg2.jpg?alt=media&token=66e0633d-c09b-4d3c-8ad0-6c113c4ab38a" alt="" className="img-fluid w-100"/>
                            <p>
