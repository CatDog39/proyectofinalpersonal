...
export function Historia(){
    ...
    return(
        <>
            <section>
                <div align="center">
                    <video src="https://firebasestorage.googleapis.com/v0/b/spotyabc-41b7d.appspot.com/o/H%C3%A9roes%20Del%20Silencio%20%20Maldito%20Duende%20Live.mp4?alt=media&token=73887234-af1b-4b49-8b92-314c9753ea42" autoPlay></video>
                </div>
            </section>
            <section>
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 col-md-4">
                            <div className="cuadro">
                                <img src="https://firebasestorage.googleapis.com/v0/b/spotyabc-41b7d.appspot.com/o/philManzanera.webp?alt=media&token=4bd03e65-4b8c-4ccd-a58b-9b855aa55589" alt="" className="img-fluid w-100"/>
                                <p>Phil Manzanera fue el productor de la etapa más gloriosa de Héroes. El músico británico produjo Senderos de Traición y El espíritu del vino, los dos discos más exitosos de la banda.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-12 col-md-4">
                            <div className="cuadro">
                                <div>
                                    <img src="https://firebasestorage.googleapis.com/v0/b/spotyabc-41b7d.appspot.com/o/Joaqu%C3%ADn_Cardiel.jpg?alt=media&token=1e1ea521-8f93-4ff1-b7c1-2aceeb12403f" alt="" className="img-fluid w-100"/>
                                    <p>Joaquín Cardiel, bajista del grupo, admirador de la cultura india, y cuyo look en muchas ocasiones estaba basado en la misma.</p>
                                </div>
                                <div>
                                    <img src="https://firebasestorage.googleapis.com/v0/b/spotyabc-41b7d.appspot.com/o/juanValdivia.jpg?alt=media&token=8ed83f28-946f-4121-b7de-de3fb73f0c03" alt="" className="img-fluid w-100"/>
                                    <p>Las desavenencias musicales entre Juan Valdivia (en la imagen) y Enrique Bunbury se fueron acrecentando desde el tercer álbum de la banda.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-12 col-md-8">
                            <h2>Consagración (1993-1996)</h2>
                            <p>
                                A principios de 1993, volvieron al estudio de grabación para registrar lo que sería su tercer álbum de estudio, El espíritu del vino, que contó también con la producción de Phil Manzanera. La grabación se llevó a cabo en los estudios Metropolis de Londres y concluyó en marzo. Fue el álbum más complejo y extenso de la banda y en el que las letras de Enrique se volvieron más enigmáticas.  Formaron parte del álbum canciones que pasarían a formar parte de su repertorio más conocido, como "Nuestros nombres" o "La sirena varada", y fue publicado en junio de forma simultánea para toda Europa. 
                    ...
                    <div className="row">
                        <div className="col-12 col-md-8">
                            <h2>Post-separación (1996-2007)</h2>
                            <p>
                        ...
                        <div className="col-12 col-md-4">
                            <div className="cuadro">
                                <img src="https://firebasestorage.googleapis.com/v0/b/spotyabc-41b7d.appspot.com/o/Enrique_Bunbury.jpg?alt=media&token=15f89972-d707-4f9e-b9c7-a85cbe9502d5" alt="" className="img-fluid w-100"/>
                                <p>Tras la disolución del grupo, Enrique Bunbury comenzó una exitosa carrera en solitario, que inició en 1997 con el álbum Radical sonora.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-12 col-md-4">
                            <div className="cuadro">
                                <img src="https://firebasestorage.googleapis.com/v0/b/spotyabc-41b7d.appspot.com/o/Foro_Sol.jpg?alt=media&token=b194af2b-ccb7-46cf-9708-5d8ac4a94dc3" alt="" className="img-fluid w-100"/>
                                <p>Presentación en vivo de Héroes del Silencio en Foro Sol, México D. F. en octubre de 2007. Las actuaciones en directo de la banda han sido más de 1000 a lo largo de 32 países de Europa y América.</p>
                            </div>
                        </div>
                        <div className="col-12 col-md-8">
                            <h2>Regreso y despedida (2007)</h2>
                            <p>
                                ...
                                Como culminación, en el concierto que cerraba la gira en Cheste, Valencia, y como consecuencia de una mala previsión, se produjo un caos circulatorio durante más de cuatro horas, además de 20 km de retenciones que imposibilitaron el acceso a miles de seguidores. 
